        ...
        <div class="layout-content-body">
          <div class="title-bar">
            ...
            <p class="title-bar-description">
              <small>This table describe all customers that are registered with you.</small>
            </p>
          </div>
    ...
    if($result = mysqli_query($link,$query)){
      ...
      while ($row = mysqli_fetch_array($result)) {
        ...
        echo '
                          ...
                          <td><span class="truncate">'.$emailId.'</span></td>
                          <td data-order="'.$emailId.'">
                            <span class="truncate">'.$club.'</span>
                          </td>
                          <td data-order="'.$birthDate.'">
                            <span class="truncate">'.$birthDate.'</span>
                          </td>
                          <td data-order="'.$sms.'">
                  ...
                  <li><a href="viewcustomerfull.php?customerId='.$customerId.'">View Full Details</a></li>
                                <li><a href="updatecustomer.php?customerId='.$customerId.'">Update</a></li>
                                <li><a href="deletecustomer.php?customerId='.$customerId.'">Delete</a></li>
                              </ul>
                            </div>
                          </td>
                        </tr>       
