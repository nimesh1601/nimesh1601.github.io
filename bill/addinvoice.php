        ...
        <div class="layout-content-body">
          <div class="title-bar">
            <h1 class="title-bar-title">
              <span class="d-ib">Add Invoice Information</span>

            </h1>
            <p class="title-bar-description">
              <small>This form is concerned for new invoice registration only</small>
            </p>
          </div>
          <div class="row">
            <div class="col-sm-6 col-sm-offset-3">
			<form action="insertinvoice.php" method="post" id="clientadd" enctype="multipart/form-data"> 
              <div class="form-group">
                <h4>Customer Details :</h4>
              </div>        
              <div class="form-group">
                <label for="contact">Contact</label>
                <input name="contact" class="form-control" type="text" id="contact" onchange="showHint(this.value)">
              </div>
              <p id="txtHint">
              </p>
              <br>
              ...
              <div class="form-group">
                ...
                <input name="offer" class="form-control" type="text"  id="offer">
              </div>
              <br>
              <div class="form-group">
                <label for="gTotal">Grand Total</label>
                <input name="gTotal" class="form-control" type="text"  id="gTotal" readonly="true">
              </div>
              <br>                                      
              <div class="form-group">
...
<script type="text/javascript">
  function addItem() {
    $("#productd").append('<br>  <div class="row gutter-xs"> <div class="col-sm-4"> <div class="form-group"> <label for="serviceName">Service Name</label> <input name="serviceName[]" class="form-control" type="text"> </div></div><div class="col-sm-4"> <div class="form-group"> <label for="rate">Rate</label> <input name="rate[]" class="form-control" type="text"> </div></div><div class="col-sm-4"> <div class="form-group"> <label for="amount">Amount</label> <input name="amount[]" class="form-control amount" type="text"> </div></div></div>');
       

  }

  function deleteItem() {
    $("#productd").html('  <div class="row gutter-xs"> <div class="col-sm-4"> <div class="form-group"> <label for="serviceName">Service Name</label> <input name="serviceName[]" class="form-control" type="text"> </div></div><div class="col-sm-4"> <div class="form-group"> <label for="rate">Rate</label> <input name="rate[]" class="form-control" type="text"> </div></div><div class="col-sm-4"> <div class="form-group"> <label for="amount">Amount</label> <input name="amount[]" class="form-control" type="text"> </div></div></div>');
  }
  function caltotal(){
      var value=0;
